...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const downloadUrls = {
        windows: 'https://github.com/carajprethvi-compliance/NCEXPRESS_DOWNLOADS_V1.0.0/releases/download/v1.0.0/NCEXPRESS_SETUP_v1.0.7.rar', // Direct download link to Windows executable
