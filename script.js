...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const downloadUrls = {
        windows: 'https://github.com/carajprethvi-compliance/NCEXPRESS_DOWNLOADS_V1.0.0/releases/download/v1.0.0/NCEXPRESS_v1.0.2_Setup.exe', // Direct download link to Windows executable
